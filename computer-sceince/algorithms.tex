...
This can be done using the Lagrange interpolation formula, which is a polynomial of degree bound $n-1$.
This should work if we have $k$ points, and we know which $x$ they were evaluated at.
